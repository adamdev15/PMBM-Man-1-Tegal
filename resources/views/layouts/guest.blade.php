...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Login Admin PMBM MAN 1 Tegal</title>
        <meta name="description" content="Login Admin PMBM MAN 1 Tegal">
        <meta name="keywords" content="Login Admin PMBM MAN 1 Tegal">
